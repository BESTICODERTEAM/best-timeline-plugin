...
(function() {
  ...
  var HorizontalTimeline = function(element) {
		...
		this.eventsMinDistance = 85; // min distance between two consecutive events (in px)
		this.eventsMaxDistance = 190; // max distance between two consecutive events (in px)
